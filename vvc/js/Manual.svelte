<div id="manual">
    ...
    <h4>Expressions</h4>
    <p>
        Everything is an expression. Since you can't have side-effects or
        mutation, things only matter if they are assigned to something.
    </p>
    <p>
        Because of that, everything evaluates to something. Functions must
        return something, all branches must return a value, etc.
    </p>
    <h4>Definitions</h4>
    <p>
    ...
    <h4>Functions</h4>
    <p>
        You can think of functions as just another type. It's a very special
        type which can be called. When called with all the required arguments,
        it will evaluate to a value.
    </p>
    <p>
        Function definition consists of arguments it takes, return type and
        body. Arguments are names with types, return type is the type of the
    ...
    <ul>
        ...
        <li>
            <span class="term"
                >list_get: (List&lt;*A&gt;, Int) -&gt; Option&lt;*A&gt;</span
            >
            — for getting an item from the given index
        </li>
        <li>
            <span class="term"
                >list_map: (List&lt;*A&gt;, (*A) -&gt; *B) -&gt; List&lt;*B&gt;</span
            >
